// TouchTexture class - handles mouse/touch interaction
class TouchTexture {
  constructor() {
    this.size = 64;
...
// GradientBackground class - handles WebGL gradient rendering
...
class WebGLBackgroundApp {
  constructor() {
    ...
    this.renderer.domElement.id = "webgl-background";
...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", () => {
    window.webglApp = new WebGLBackgroundApp();
  });
} else {
  window.webglApp = new WebGLBackgroundApp();
}
